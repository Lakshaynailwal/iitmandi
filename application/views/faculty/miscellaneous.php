...
<style>
    ...
    .active {background: #032851 !important; color: #fff !important;}</style>
<main id="main">
    <!-- ======= Breadcrumbs Section ======= -->
                    ...
                    <div class="portfolio-info">
                        ...
                        <div class="row">
                            <div class="col-12 profile_menu" style="text-align:center">
                                ...
                                <a href="<?php echo base_url()?>faculty/miscellaneous"><button type="button" class="btn btn-primary active">Miscellaneous</button></a>
                                <!-- Tab navs -->
                            </div>
                            <!-- Miscellaneous Start -->
